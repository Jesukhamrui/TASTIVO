...
function Checkout() {
    ...
    }, [cart.cartItems.length, history, orderPlaced]);
    ...
    const handlePlaceOrder = async () => {
        ...
        try {
            ...
            // Store order data and show payment gateway
            setCurrentOrder({
                id: orderData.id,
    ...
    const handlePaymentSuccess = async (paymentData) => {
        ...
        dispatch(
            addOrder({
                ...
                paymentStatus: "paid",
                transactionId: paymentData.razorpay_payment_id || paymentData.transactionId,
            })
        );

        setPaymentStatus("paid");
        setTransactionId(paymentData.razorpay_payment_id || paymentData.transactionId);
        setOrderPlaced(true);
    ...
    const handlePaymentCancel = () => {
        setShowPaymentGateway(false);
        setError("Payment was cancelled. Your order has been saved. You can retry payment later.");
    };
        ...
        <div className="checkout-container">
            ...
            {showPaymentGateway && currentOrder && (
                <PaymentGateway
                    ...
                    customerEmail={currentOrder.deliveryDetails.email}
                    customerPhone={currentOrder.deliveryDetails.phone}
                    customerName={currentOrder.deliveryDetails.fullName}
