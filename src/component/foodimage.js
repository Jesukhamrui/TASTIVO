...
const Food = [
    ...
    {
        id: 14, // Unique ID
        url: require("../component/Dashboard/image/paneer-tikka.png"), // Path to new image
        rate: '200',
        title: 'Paneer Tikka',
        quantity: '300g',
        star: 4,
        description: 'Grilled paneer cheese with spices and vegetables, a popular Indian appetizer.',
        titlename: 'IndianFood',
        titleId: 1
    },
    {
        id: 15, // Unique ID
        url: require("../component/Dashboard/image/biryani.png"), // Path to new image
        rate: '300',
        title: 'Biryani',
        quantity: '600g',
        star: 5,
        description: 'Aromatic rice dish with spices, vegetables, and optional meat, a classic Indian delicacy.',
        titlename: 'IndianFood',
        titleId: 1
    },
    {
        id: 16,
        url: require("../component/Dashboard/image/butter-chicken.png"),
        rate: '250',
    ...
    {
        id: 17,
        url: require("../component/Dashboard/image/chole-bhature.png"),
        rate: '150',
        title: 'Chole Bhature',
        quantity: '2 Pieces',
        star: 4,
    ...
    {
        id: 18,
        url: require("../component/Dashboard/image/dal-tadka.png"),
        rate: '120',
        title: 'Dal Tadka',
        quantity: '400g',
        star: 4,
        description: 'Yellow lentils tempered with spices, a comforting Indian staple.',
        titlename: 'IndianFood',
        titleId: 1
    },
    {
        id: 19,
        url: require("../component/Dashboard/image/masala-dosa.png"),
        rate: '100',
        title: 'Masala Dosa',
        quantity: '1 Piece',
        star: 5,
        description: 'Crispy rice pancake filled with spiced potato filling, served with chutney.',
        titlename: 'IndianFood',
        titleId: 1
    },
    {
        id: 20,
        url: require("../component/Dashboard/image/palak-paneer.png"),
        rate: '180',
        title: 'Palak Paneer',
        quantity: '400g',
        star: 4,
        description: 'Paneer cubes in a creamy spinach gravy, a popular vegetarian dish.',
        titlename: 'IndianFood',
        titleId: 1
    },
    {
        id: 21,
        url: require("../component/Dashboard/image/rogan-josh.png"),
        rate: '280',
        title: 'Rogan Josh',
        quantity: '500g',
        star: 5,
        description: 'Aromatic lamb curry with a rich, spiced yogurt-based sauce.',
        titlename: 'IndianFood',
        titleId: 1
    },
    {
        id: 22,
        url: require("../component/Dashboard/image/idli-sambar.png"),
        rate: '80',
        title: 'Idli Sambar',
        quantity: '4 Pieces',
        star: 4,
        description: 'Steamed rice cakes served with lentil-based sambar and chutney.',
        titlename: 'IndianFood',
        titleId: 1
    },
    {
        id: 23,
        url: require("../component/Dashboard/image/naan.png"),
        rate: '50',
        title: 'Naan',
        quantity: '1 Piece',
        star: 4,
    ...
    {
        id: 24,
        url: require("../component/Dashboard/image/samosa.png"),
        rate: '60',
        title: 'Samosa',
        quantity: '2 Pieces',
        star: 5,
        description: 'Crispy pastry filled with spiced potatoes and peas, a popular snack.',
        titlename: 'IndianFood',
        titleId: 1
    },
    {
        id: 25,
        url: require("../component/Dashboard/image/malai-kofta.png"),
        rate: '220',
        title: 'Malai Kofta',
        quantity: '400g',
        star: 4,
        description: 'Creamy kofta balls in a rich tomato and cashew gravy.',
        titlename: 'IndianFood',
        titleId: 1
    },
    {
